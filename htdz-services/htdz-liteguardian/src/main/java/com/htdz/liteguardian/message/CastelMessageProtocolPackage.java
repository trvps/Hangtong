 ...
 *
 */
public class CastelMessageProtocolPackage {
	private CastelMessageHeadVO messageHeadVo;

	public CastelMessageProtocolPackage(CastelMessageHeadVO messageHeadVo) {
	...
	private List<Byte> packMsg(List<Byte> bMsgBodyList) {
		...
		CastelMessageHeadVO msgHeadVo = this.messageHeadVo;
